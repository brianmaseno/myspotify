          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 lg:space-x-4">
                ...
                {/* User Menu */}
                <div className="relative user-menu-container z-[99999]">
                  <motion.button
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.95 }}
                  ...
                  <AnimatePresence>
                    {showUserMenu && (
                      <motion.div
                        ...
                        className="absolute top-12 right-0 w-48 bg-black/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden z-[99999]"
                      >
                        {session ? (
                          <>
